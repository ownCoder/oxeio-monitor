...
describe('elapsedWorkdays — ট্র্যাকিং শুরুর আগের কর্মদিবস বাদ', () => {
  ...
  /**
   * ⚠️⚠️ **যে ফাঁকটা এই ফিচার ঢাকে না — লিখে রাখা হলো, ঢাকার ভান নয়।**
   *
   * বাস্তবে `trackingStartedOn` আসে `min(daily_summary.work_date)` থেকে,
   * আর `refreshDate()` প্রতিটি **active** কর্মীর সারি লেখে (ডেটা থাক বা
   * না থাক)। তাই ৩ আগস্ট সক্রিয় হওয়া কর্মীর প্রথম সারিটা ৩ তারিখেই বসে
   * যায় — এজেন্ট ১৩ তারিখে বসলেও। অর্থাৎ কলারের কাছে দুটো তারিখ **এক**,
   * আর মাঝের এজেন্টহীন দিনগুলো তার পুরো ঘাটতিই থাকে।
   *
   * ⭐ অঙ্কটা এখানে ঠিকই আছে; ফাঁকটা কলারের দিকে — "কবে দেখা শুরু" প্রশ্নের
   * উত্তর হিসেবে `daily_summary`-র প্রথম সারিটা যথেষ্ট সৎ নয়।
   */
  it('⚠️ এজেন্ট দেরিতে বসলে দিনগুলো তবু গোনা হয় — এটা ঢাকা পড়েনি', () => {
    const activatedAug3 = {
      ...BASE,
      joinedOn: day('2026-08-03'),
      // ⚠️ এজেন্ট বসেছে ১৩ তারিখে, কিন্তু সারি লেখা শুরু ৩ তারিখেই
      trackingStartedOn: day('2026-08-03'),
    };

    // ৩–১৯ আগস্ট, শুক্রবার ৭ ও ১৪ বাদে = ১৫ কর্মদিবস।
    // ⚠️ এজেন্টহীন ৩–১২ এর ৮টা দিনও এর মধ্যে আছে।
    expect(elapsedWorkdays(activatedAug3)).toBe(15);
    expect(
      elapsedWorkdays(activatedAug3) -
        elapsedWorkdays({ ...activatedAug3, trackingStartedOn: day('2026-08-13') }),
    ).toBe(9);
  });
