 ...
 *
 * ⭐ রঙের নিয়ম: `tone="counted"` = কালো (গোনা হওয়া কাজ), `"muted"` = ধূসর
 * (গোনা হয়নি), `"attention"` = লাল (ঘাটতি, এজেন্ট বন্ধ)। ⚠️ সব টাইল লাল
 * করে দিলে লাল রঙের মানেই হারিয়ে যায় — একটা পর্দায় একটার বেশি লাল টাইল
 * রাখবেন না।
 *
