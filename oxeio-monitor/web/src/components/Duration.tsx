...
/**
 * সময়কাল দেখানো — সেকেন্ড → `7ঘ 32মি`।
 *
 ...
 *
 * ⚠️ `tone="muted"` দিন যখন সময়টা **গোনা হয়নি** (idle, locked)। কালো =
 *    গোনা হওয়া কাজ, ধূসর = গোনা হয়নি — এই পার্থক্যটাই ব্র্যান্ডের নিয়ম।
 */
 ...
 *    রিপোর্ট পেজে "7.53" আর লাইভ বোর্ডে "7ঘ 32মি" দেখা যেত, আর কেউ
