 ...
 *
 * ⚠️⚠️ প্রথমে এখানে ২ মিনিট লেখা হয়েছিল, আর সেটা ছিল একটা **নীরব
 * অবনতি**: বোর্ডে সংখ্যাটা ছিল ৪ মিনিট, তাই সরানোর সাথে সাথেই audit
 * সারির হার দ্বিগুণ হয়ে যেত — অথচ পুরো সরানোর একটা লাভই ছিল ওই খরচ কমা।
 *
 * ⭐ কারণটা `latestShots.ts`-এর মাথায়: `GET /screenshots`-এর প্রতিটা কল
 * একটা করে audit সারি লেখে (I08 — "কে আমার স্ক্রিনশট দেখল"), আর ছবি
 * এমনিতেই জমে **৫ মিনিট পরপর** — ঘন ঘন ডাকলে একই ছবিই ফিরে আসে।
 */
