...
{
    /// <summary>
    /// গোনা সংখ্যার সাথে সর্বোচ্চ যতটুকু নিজে থেকে যোগ করা হবে।
    ///
    /// ⚠️⚠️ ছাদটা <b>অপরিহার্য</b>। সার্ভারের সাথে যোগাযোগ কেটে গেলে বা এজেন্ট
    /// আটকে গেলে anchor পুরোনো হয়ে পড়ে থাকে, আর ছাদ না থাকলে জানালা
    /// নিজে থেকেই <b>ঘণ্টার পর ঘণ্টা বানিয়ে</b> দেখাত — অর্থাৎ যে সংখ্যাটা
    /// দিয়ে বেতন হিসাব হয় সেটা নিয়েই মিথ্যা বলত। ৫ মিনিট heartbeat-এর
    /// ব্যবধানের চেয়ে যথেষ্ট বড়, তাই স্বাভাবিক অবস্থায় ছাদে ঠেকেই না।
    /// ⭐ ছাদে ঠেকলে সংখ্যাটা <b>জমে যায়</b> — আর সেটাই সৎ উত্তর: আমরা জানি না।
    ///    (tray-র "Sync" ঘরটা তখন এমনিতেই গোলমাল দেখাচ্ছে।)
    /// </summary>
    public static readonly TimeSpan MaxDrift = TimeSpan.FromMinutes(5);
