...
| | |
|---|---|
| **স্ট্যাটাস** | 🔨 সব স্তর দাঁড়িয়েছে — এজেন্ট · সার্ভার (**৭৬ endpoint**) · ড্যাশবোর্ড (৬ পাতা)। **১২১৪ টেস্ট পাস** (সার্ভার ৭৩২ · এজেন্ট ৪১৮ · ওয়েব ৬৪)। ১১ আগস্ট আসল এজেন্ট প্রথমবার সার্ভারে ডেটা পাঠিয়েছে — রাতে **নিজের তোলা স্ক্রিনশটও**। ⚠️ কী মাঠে চলেছে আর কী শুধু বিল্ড পাস করেছে — [09 § ৩ঈ](docs/09-Build-Log.md) |
| **প্রতিষ্ঠান** | oXeio |
...
| **সার্ভার** | **VPS** ([ADR-026](docs/05-Options-Decisions.md)) — সুপারিশ ৪ GB RAM · ২ vCPU · **৮০ GB ডিস্ক** (৯০ দিনের ছবি ≈ ২২ GB + DB ও ব্যাকআপ) |
...
- **`server/`** NestJS 11 + Prisma 6 · ১৯ মডেল · **৭৬ endpoint**
  (৫৬ ড্যাশবোর্ড · ১০ auth · ১০ এজেন্ট) · **৭৩২ টেস্ট**
