...
| | |
|---|---|
| **স্ট্যাটাস** | 🔨 সব স্তর দাঁড়িয়েছে — এজেন্ট · সার্ভার (~৪৫ endpoint) · ড্যাশবোর্ড (৬ পাতা)। **৯১৩ টেস্ট পাস** (সার্ভার ৫৮৬ · এজেন্ট ৩২৭)। ১১ আগস্ট আসল এজেন্ট প্রথমবার সার্ভারে ডেটা পাঠিয়েছে। ⚠️ কী মাঠে চলেছে আর কী শুধু বিল্ড পাস করেছে — [09 § ৩ঈ](docs/09-Build-Log.md) |
| **প্রতিষ্ঠান** | oXeio |
...
> চালিয়ে দেখা হয়েছে — **আসল এজেন্ট** এনরোল হয়ে segment, app usage ও
> আপডেট নামানো পর্যন্ত করেছে; ব্যাকআপ ডিক্রিপ্ট করে **restore** পর্যন্ত
> মিলিয়ে দেখা হয়েছে; 2FA, H04 রোলআউট ও তিনটে অ্যালার্ট পথও চলেছে।
> ⚠️ কিন্তু **TLS, ইমেইল/টেলিগ্রাম, অফসাইট ব্যাকআপ কপি** — এখনো একবারও
> চলেনি, আর **এজেন্টের নিজের তোলা ছবি সার্ভারে পৌঁছায়নি**।
> তিন ভাগে সাজানো তালিকা → [09-Build-Log § ৩ঈ](docs/09-Build-Log.md)

> 🐛 **সেই চালানোতেই তিনটে বাগ বেরিয়েছে**, তিনটেই "সত্যিই চালালে তবেই ধরা
> পড়ে" জাতের — সবচেয়ে গুরুতরটা: MSI ডাউনলোড `200 OK` আর সঠিক
> `Content-Length` পাঠিয়ে **শূন্য বাইট** দিত, অর্থাৎ auto-update কোনোদিন
> কাজ করতে পারত না। বিস্তারিত → [09 § ৩ঋ](docs/09-Build-Log.md)
