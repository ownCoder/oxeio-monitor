...
CREATE TABLE agent_versions (
  ...
  --    ৬ঘ ধরে বিল্ডটা চালিয়ে এখনো সাড়া দিচ্ছে (G141, devices.agent_version_since)
...
| **প্রতি ঘণ্টায় `:07`** | ⭐⭐ এজেন্ট-রোলআউট এগোনো — `canary → partial → all`। ⚠️ শর্ত **সময় নয়, প্রমাণ**: একটা আসল মেশিন বিল্ডটা ৬ঘ চালিয়ে এখনো সাড়া দিচ্ছে কি না। ⚠️⚠️ `halted` কখনো নিজে খোলে না (G141, [09 § ৩ঞ২৭](09-Build-Log.md)) |
