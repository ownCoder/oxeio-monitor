...
| **Add Design Targets** ⭐ | *(২২–২৩ আগস্ট)* গবেষক · ম্যানেজার · মালিক — একবারে ৫০০টা Amazon URL পেস্ট। ⚠️ বাতিল লাইনগুলো **লাইন নম্বর, লেখা ও কারণসহ** ফেরত আসে; ৫০০-র মধ্যে ৬টা বাদ পড়লে কোন ৬টা সেটা না জানলে ওগুলো আর সংগ্রহ করা হতো না |
| **All Design Targets** ⭐ | পুরো তালিকা — ছাঁকনি · **URL বা ASIN দিয়ে খোঁজা** · পাতা ভাগ (৫০/পাতা, টেবিলে ৩৯ হাজার সারি) · কে ও কবে · সম্পাদনা (To pool · Complete · Skip · Delete)। ⚠️⚠️ **ASIN বদলানোর পথ নেই** — ওটা সারিটার পরিচয়, আর ডুপ্লিকেট-প্রহরী ওটার উপরেই দাঁড়ানো |
