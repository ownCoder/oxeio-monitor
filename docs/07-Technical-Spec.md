...
- [ ] **নিজে সই করা** সার্ট বানিয়ে MSI-তে সই, আর `.cer` ১৫টা PC-র Trusted Publishers-এ ([ADR-014](05-Options-Decisions.md)) — কেনা সার্ট লাগবে না
- [ ] প্রতিটা স্টাফের **যোগদানের তারিখ** বসানো — নইলে proration (G37) কখনো চালু হবে না
