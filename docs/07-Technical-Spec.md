...
- [ ] *(ঐচ্ছিক)* সইয়ের তারিখ ড্যাশবোর্ডে বসানো — Settings → Staff → "Record signature"। ⚠️ কোডে এটা **কিছুই আটকায় না**, শুধু নথি হিসেবে থাকে
...
- [ ] **VPS তৈরি** ([ADR-026](05-Options-Decisions.md)) — ৪ GB RAM · ২ vCPU · ৮০ GB ডিস্ক · ডোমেইন বসানো · Let's Encrypt · ফায়ারওয়ালে শুধু ৪৪৩ (আর SSH) · ডিস্ক এনক্রিপশন · অটো ব্যাকআপ · রিবুটে Docker নিজে ওঠা
