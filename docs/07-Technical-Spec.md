...
| GET·POST·DELETE | `/leaves?month=` · `/leaves` · `/leaves/:id` | ⭐ **owner only** (R2) — ছুটির খাতা। ⚠️ `?month=` **বাধ্যতামূলক**: খাতা বছরের পর বছর বাড়ে, আর "সব ছুটি" চাওয়ার মতো পর্দা নেই। ⭐ POST **রেঞ্জ ধরে** (`from`/`to`) — মানুষ "১০ থেকে ১৪" ছুটি নেয়, "১০" পাঁচবার নয়; আগে থেকেই খাতায় থাকা দিন বাদ পড়ে আর উত্তরে `skipped[]` হয়ে ফেরে, নইলে পর্দা "৫টা যোগ হয়েছে" বলত যখন আসলে ৩টা। ⚠️ manager নেই — পর্দাটা Settings-এ, আর গোটা Settings owner-এর; খুলে রাখলে API এমন দরজার দাবি করত যেটায় পৌঁছানোর পথ নেই |
