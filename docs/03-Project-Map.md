...
│   └── test/                               ✅ Vitest + supertest — **১৭৫০টি টেস্ট, ৮৮টি ফাইল** *(৬ সেপ্টেম্বর মাপা, ১টি skipped)*
│       #  ⚠️ ৫১টি ফাইল DB ছাড়াই চলে (**১২০৯** টেস্ট, `npm run test:nodb`);
│       #     ৩৭টি `*.e2e.spec.ts` (**৫৪১**) Postgres ছাড়া চলে না
